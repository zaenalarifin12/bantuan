...
class SubKriteriaSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table("sub_kriteria")->insert([
            ...
            ["id" => 5,     "kriteria_id" => 2,     "nama" =>	"marmer/granit",    "nilai" => 1],
            ["id" => 6,     "kriteria_id" => 2,     "nama" =>	"semen/bata merah", "nilai" => 2],
            ["id" => 7,     "kriteria_id" => 2,     "nama" =>	"ubin/tegel",       "nilai" => 3],
            ["id" => 8,     "kriteria_id" => 2,     "nama" =>	"permadani",        "nilai" => 4],
            ["id" => 9,     "kriteria_id" => 2,     "nama" =>	"keramik",          "nilai" => 5],
            ["id" => 10,    "kriteria_id" => 2,     "nama" =>	"kayu",             "nilai" => 6],
            ["id" => 11,    "kriteria_id" => 2,     "nama" =>	"bambu",            "nilai" => 7],

            ["id" => 12,    "kriteria_id" => 3,     "nama" =>	"kayu",             "nilai" => 5],
            ["id" => 13,    "kriteria_id" => 3,     "nama" =>	"bambu",            "nilai" => 4],
            ["id" => 14,    "kriteria_id" => 3,     "nama" =>	"plester",          "nilai" => 3],
            ["id" => 15,    "kriteria_id" => 3,     "nama" =>	"batu bata",        "nilai" => 2],
            ["id" => 16,    "kriteria_id" => 3,     "nama" =>	"tembok",           "nilai" => 1],

            ["id" => 17,    "kriteria_id" => 4,     "nama" =>	"tanpa fasilitas",      "nilai" => 6],
            ["id" => 18,    "kriteria_id" => 4,     "nama" =>	"bersama oranglain",    "nilai" => 2],

            ["id" => 19,    "kriteria_id" => 5,     "nama" =>	"sumur bor",            "nilai" => 7],
            ["id" => 20,    "kriteria_id" => 5,     "nama" =>	"sumur terlindugi",     "nilai" => 6],
            ["id" => 21,    "kriteria_id" => 5,     "nama" =>	"air hujan",            "nilai" => 5],
            ["id" => 22,    "kriteria_id" => 5,     "nama" =>	"air kemasan",          "nilai" => 4],
            ["id" => 23,    "kriteria_id" => 5,     "nama" =>	"air isi ulang",        "nilai" => 3],
            ["id" => 24,    "kriteria_id" => 5,     "nama" =>	"leding meteran",       "nilai" => 2],

            ["id" => 25,    "kriteria_id" => 6,     "nama" =>	"Gas 3kg",              "nilai" => 2],
            ["id" => 26,    "kriteria_id" => 6,     "nama" =>	"kayu bakar",           "nilai" => 4],
            ["id" => 27,    "kriteria_id" => 6,     "nama" =>	"minyak tanah",         "nilai" => 3],
            ["id" => 28,    "kriteria_id" => 6,     "nama" =>	"gas >3kg",             "nilai" => 1],
            ["id" => 29,    "kriteria_id" => 6,     "nama" =>	"tidak memasak dirumah","nilai" => 6],
            ["id" => 30,    "kriteria_id" => 6,     "nama" =>	"arang",                "nilai" => 5],
            ...
            ["id" => 36,    "kriteria_id" => 8,     "nama" =>"1",                       "nilai" => 6],
            ["id" => 37,    "kriteria_id" => 8,     "nama" =>"2",                       "nilai" => 4],
            ...
            ["id" => 45,    "kriteria_id" => 10,    "nama" =>"ya",                      "nilai" => 2],
            ["id" => 46,    "kriteria_id" => 10,    "nama" =>"tidak",                   "nilai" => 6],
            ...
            ["id" => 56,    "kriteria_id" => 13,    "nama" =>"500.000",                     "nilai" => 6],
            ["id" => 57,    "kriteria_id" => 13,    "nama" =>"500.000-1.000.000",        "nilai" => 4],
